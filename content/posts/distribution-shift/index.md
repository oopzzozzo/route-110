...
| ![台灣訂單運費分佈](distribution-shift_ecommence-shipping-fee.png) | ![誤算之台灣訂單運費分佈](distribution-shift_ecommence-shipping-fee-bug.png) |
...
| --- | --- | --- |
| ![記憶體使用率分佈例圖](distribution-shift_machine-memory-usage.png)| ![記憶體使用率上升](distribution-shift_machine-memory-usage-right-shift.png) | ![記憶體使用率上升](distribution-shift_machine-memory-usage-exception.png) |
