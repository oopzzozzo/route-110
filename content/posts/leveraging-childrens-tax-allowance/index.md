+++
title = '免稅額給長輩'
date = 2026-04-26T15:27:30+08:00
categories = ['心得']
draft = true
+++
### 源起
...
#### 夫妻分別計稅的五種情形選擇{#split-ones-income}
...
如果把夫妻和孩的稅單放一起看。會發現三段金額大小實在太不平均，孩子那段是負值。
...
- 夫妻戶選切一方之薪資所得。這種情況下，夫妻利用配偶分別計稅偷開外掛，把單一方賺的錢拆成兩包計稅（如[例一](#split-ones-income)）。若孩子扶養則無法達到這種效果。夫妻應先考慮把所得分配給另一方，孩子的免稅額才能發揮作用。
